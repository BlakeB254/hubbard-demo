...
const MOCK_PROMOTER_LINKS: PromoterLink[] = [
  {
    ...
    eventId: '1',
    promoterId: 'user-1',
    url: 'https://hubbardinn.com/e/1?ref=PROMO2024',
    clicks: 1245,
    conversions: 89,
    revenue: 13350,
    isActive: true,
  ...
  },
  {
    ...
    eventId: '3',
    promoterId: 'user-1',
    url: 'https://hubbardinn.com/e/3?ref=VIPNIGHT',
    clicks: 567,
    conversions: 23,
    revenue: 11500,
    isActive: true,
  ...
  },
  {
    ...
    eventId: '4',
    promoterId: 'user-1',
    url: 'https://hubbardinn.com/e/4?ref=HIPHOP50',
    clicks: 892,
    conversions: 156,
    revenue: 7020,
    isActive: true,
...
export async function getPromoterEarnings(): Promise<PromoterEarnings> {
  ...
  return {
    ...
    pendingPayout: 4780,
    byEvent: [
      { eventId: '1', eventName: 'New Year\'s Eve Gala', revenue: 89000, commission: 13350, conversions: 89 },
      { eventId: '3', eventName: 'VIP Bottle Service', revenue: 57500, commission: 11500, conversions: 23 },
      { eventId: '4', eventName: 'Hip Hop Takeover', revenue: 58500, commission: 7020, conversions: 156 },
    ],
  };
}
